...
# fluxo:
# 1) lê pending_offers.json
# 2) envia até MAX_OFFERS_PER_RUN
# 3) remove do pending apenas o que foi enviado com sucesso
# 4) reforça o histórico por slug de forma defensiva
...
GRUPO_COMENTARIOS_ID = os.environ.get("GRUPO_COMENTARIO_ID", "").strip()
